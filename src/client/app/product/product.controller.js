(function() {
    ...
    /* @ngInject */
    function Product($state, ProductService, routerHelper, logger, common, toastr, config, _, $sce, $rootScope, $scope, $timeout, $document) {
        ...
        //page scroll to top on click of new page from navigation bar starts
        $('.pageload').click(function() {
            window.scroll(0, 0);
        });
        //page scroll to top on click of new page from navigation bar ends   

        //Email Functionality Starts
        $scope.EmailFunction = function(obj) {
            angular.element('#tamilid').attr('disabled', 'disabled');
            angular.element('#engid').attr('disabled', 'disabled');
            ...
            if (obj !== "" && obj !== undefined) {
                ...
                ProductService.sendengEmail(request, MethodType).then(function(res) {
                    $rootScope.httpRequestloading = false;
                    angular.element('#Email').val('');
                    angular.element('#Name').val('');
                    angular.element('.email').val('');
                    angular.element('.name').val('');
                    toastr.success('We appreciate your reference', 'Request submitted successfully', { timeOut: 2000 });
